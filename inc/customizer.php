...
function accepta_global_colors_css() {
	...
	if ( $primary_color && $primary_color !== '#6f9c50' ) {
		...
		$css .= '.main-navigation a:hover, .main-navigation a:focus, .main-navigation li:hover > a, .main-navigation li.focus > a, .main-navigation li:focus-within > a { color: ' . esc_attr( $primary_color ) . '; }';
