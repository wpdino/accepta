...
/**
 * Title: Contact Page
 * Slug: accepta/page-contact
 * Description: Full contact page layout for Accepta.
...
<h1 class="wp-block-heading has-text-align-center has-white-color has-text-color">Contact</h1>
<!-- /wp:heading --></div></div>
<!-- /wp:cover -->
...
<p class="has-text-align-center has-large-font-size">Get in touch — we'd love to hear from you.</p>
<!-- /wp:paragraph -->
