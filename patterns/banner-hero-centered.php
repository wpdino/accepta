...
/**
 * Title: Hero Centered
 * Slug: accepta/hero-centered
 * Description: Accepta hero centered block pattern.
...
<h2 class="wp-block-heading has-text-align-center has-white-color has-text-color has-xx-large-font-size">Your Story Starts Here</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"white"} -->
<p class="has-text-align-center has-white-color has-text-color">Fullscreen hero, overlay header, and flexible layouts.</p>
<!-- /wp:paragraph -->

<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
<div class="wp-block-buttons"><!-- wp:button {"backgroundColor":"primary"} -->
<div class="wp-block-button"><a class="wp-block-button__link has-primary-background-color has-background wp-element-button" href="#">Explore Accepta</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div></div>
<!-- /wp:cover -->
